...
const EMPTY = {
  ...
  setup: "Breakout", timeframe: "H1", emotion: "Calm",
  ...
  return (
    <div className="log-page">
      <div className="page-header" style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <div>
          <h1>
            {tradeType === "backtest" ? "Backtest" : "Real-time"} trade
            <span className={`badge badge-${tradeType === "backtest" ? "bt" : "rt"}`} style={{ marginLeft: 10, fontSize: 12 }}>{tradeType}</span>
          </h1>
